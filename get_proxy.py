...
"""
Outputs a list of proxies to proxies.txt that are supposed to be L1.

Run by using python get_proxy.py -s number of proxies to scrape

IE: "python get_proxy.py -s 30" returns 30 proxies that pass craigslist test
"""
# TO DO:
# -Add http://free-proxy-list.net/
# -Add hidemyass

__author__ = 'Billy Reynolds'
__contact__ = 'billy@leadfocusmarketing.com'
